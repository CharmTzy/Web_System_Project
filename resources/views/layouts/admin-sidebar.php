...
$adminNavItems = [
    ...
    ['label' => 'Manage returns', 'href' => '/admin/returns.php', 'icon' => 'returns', 'match' => static fn (string $path): bool => str_starts_with($path, '/admin/returns.php') || str_starts_with($path, '/admin/return-view.php')],
    ...
    ['label' => 'Manage reviews', 'href' => '/admin/reviews.php', 'icon' => 'help', 'match' => static fn (string $path): bool => str_starts_with($path, '/admin/reviews.php')],
