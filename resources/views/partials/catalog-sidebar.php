    ...
    <div class="catalog-sidebar__panel">
        <div class="catalog-sidebar__section">
            ...
            <nav class="sidebar-category-list" aria-label="Catalog categories">
                <a class="sidebar-category-link <?= $catalogView['filters']['category'] === '' ? 'is-active' : '' ?>"
                    href="<?= e($buildCatalogUrl(['category' => null])) ?>" data-category-link data-category-value="">
                    All products
                </a>
                <?php foreach ($catalogView['categories'] as $category): ?>
                    <a class="sidebar-category-link <?= $catalogView['filters']['category'] === $category['slug'] ? 'is-active' : '' ?>"
                        href="<?= e($buildCatalogUrl(['category' => $category['slug']])) ?>" data-category-link
                        data-category-value="<?= e($category['slug']) ?>">
            ...
            <div class="catalog-sidebar__section">
                ...
                <div class="sidebar-price-grid">
                    <div class="form-group">
                        ...
                        <input id="min_price" class="form-control" type="number" name="min_price" min="0" step="0.01"
                    ...
                    <div class="form-group">
                        ...
                        <input id="max_price" class="form-control" type="number" name="max_price" min="0" step="0.01"
            ...
            <div class="catalog-sidebar__section">
                ...
                <label class="toggle-field" for="in_stock">
                    <input id="in_stock" type="checkbox" name="in_stock" value="1"
                        <?= $catalogView['filters']['in_stock'] ? 'checked' : '' ?>>
