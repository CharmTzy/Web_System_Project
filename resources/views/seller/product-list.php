...
<div class="section-block">
    <div class="section-block__header">
        <div>
            <span class="results-header__eyebrow">Product management</span>
            <h2><?= e((string) count($products)) ?> listings</h2>
        </div>
        <a class="btn btn-brand" href="/seller/product-edit.php">Add product</a>
    </div>
    ...
    <?php if ($products === []): ?>
        <div class="empty-state">
            ...
            <p>Create your first listing to start selling on NovaMarket.</p>
            <a class="btn btn-brand" href="/seller/product-edit.php">Create product</a>
        </div>
    <?php else: ?>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <small class="text-muted"><?= e((string) $product['short_description']) ?></small>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                ...
                                <?php if ($product['compare_price'] !== null): ?>
                                    <br><small class="text-muted"><s><?= e(money((float) $product['compare_price'])) ?></s></small>
                                <?php endif; ?>
                            </td>
                            ...
                            <td>
                                <div class="d-flex gap-2 flex-wrap">
                                    <a class="btn btn-brand-outline" href="/seller/product-edit.php?id=<?= e((string) $product['id']) ?>" style="padding:0.4rem 0.8rem;font-size:0.85rem;">Edit</a>
                                    <form method="post" action="/seller/products.php" onsubmit="return confirm('Delete this product?');">
