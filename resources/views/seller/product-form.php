...
<div class="profile-card">
    ...
    <form class="auth-form" method="post" enctype="multipart/form-data" action="/seller/product-edit.php<?= $isEdit ? '?id=' . e((string) $editProduct['id']) : '' ?>">
