...
INSERT INTO products (
    ...
    (1, 2, 1, 'MM-TECH-001', 'Nova Wireless Earbuds', 'nova-wireless-earbuds', 'Noise-controlled earbuds with a pocket-size charging case.', 'Nova Wireless Earbuds are tuned for commuting and study sessions, with balanced sound, touch controls, and a secure in-ear fit.', 79.90, 99.90, 24, 'https://placehold.co/640x480/e6dbc8/152238?text=Nova+Earbuds', 4.80, 128, 1, 1, '2026-02-02 10:15:00'),
    (2, 3, 1, 'MM-TECH-002', 'Echo Mechanical Keyboard', 'echo-mechanical-keyboard', 'Compact tactile keyboard with hot-swappable switches.', 'Echo Mechanical Keyboard is built for long typing sessions, with sound-dampened keys, USB-C connectivity, and adjustable tilt.', 119.00, NULL, 12, 'https://placehold.co/640x480/d7e6e0/152238?text=Echo+Keyboard', 4.70, 74, 1, 1, '2026-01-20 09:45:00'),
    (3, 3, 2, 'MM-HOME-001', 'Halo Standing Desk Lamp', 'halo-standing-desk-lamp', 'Adjustable LED lamp with warm-to-cool light presets.', 'Halo Standing Desk Lamp offers glare-free lighting, a compact footprint, and four brightness zones for home office setups.', 64.50, 84.50, 16, 'https://placehold.co/640x480/f1ead9/152238?text=Desk+Lamp', 4.60, 59, 1, 0, '2026-01-15 16:30:00'),
    (4, 4, 3, 'MM-KITCHEN-001', 'Ember Mug Warmer', 'ember-mug-warmer', 'Desk-friendly warmer that keeps coffee and tea at serving temperature.', 'Ember Mug Warmer uses low-profile heating with a splash-safe surface and one-button controls for shared workspaces.', 42.90, NULL, 31, 'https://placehold.co/640x480/f4d8cd/152238?text=Mug+Warmer', 4.50, 113, 1, 0, '2026-02-10 08:10:00'),
    (5, 4, 4, 'MM-WELL-001', 'Solace Aroma Diffuser', 'solace-aroma-diffuser', 'Ceramic diffuser with quiet mist modes and timer presets.', 'Solace Aroma Diffuser brings a subtle mist output, soft ambient light, and auto shutoff for evening routines.', 58.00, 72.00, 9, 'https://placehold.co/640x480/dae7df/152238?text=Diffuser', 4.90, 98, 1, 1, '2026-02-24 12:00:00'),
    (6, 5, 5, 'MM-LIFE-001', 'TideFold Weekender Bag', 'tidefold-weekender-bag', 'Water-resistant carry bag sized for short trips and day use.', 'TideFold Weekender Bag includes a padded laptop sleeve, trolley strap, and separate shoe compartment.', 89.00, 110.00, 7, 'https://placehold.co/640x480/e6e1d5/152238?text=Weekender+Bag', 4.70, 45, 1, 0, '2026-01-08 14:20:00'),
    (7, 4, 4, 'MM-WELL-002', 'Pulse Smart Bottle', 'pulse-smart-bottle', 'Insulated bottle with hydration reminders and a carry loop.', 'Pulse Smart Bottle tracks your refill routine, keeps drinks cool, and charges with a hidden USB-C port.', 54.00, NULL, 18, 'https://placehold.co/640x480/d7e5ea/152238?text=Smart+Bottle', 4.40, 67, 1, 0, '2026-02-12 11:15:00'),
    (8, 4, 2, 'MM-HOME-002', 'Hearth Throw Blanket', 'hearth-throw-blanket', 'Soft woven blanket for lounge corners and reading nooks.', 'Hearth Throw Blanket uses a textured weave and machine-washable fibers for everyday living spaces.', 49.00, 65.00, 20, 'https://placehold.co/640x480/eadac6/152238?text=Throw+Blanket', 4.80, 39, 1, 0, '2026-02-18 15:10:00'),
    (9, 4, 3, 'MM-KITCHEN-002', 'AeroBlend Portable Blender', 'aeroblend-portable-blender', 'Rechargeable smoothie blender for desks, dorms, and travel.', 'AeroBlend Portable Blender crushes soft fruit and ice, detaches for washing, and stores neatly in a drawer.', 68.00, 82.00, 14, 'https://placehold.co/640x480/dbe7df/152238?text=Portable+Blender', 4.30, 53, 1, 1, '2026-02-05 13:35:00'),
    (10, 5, 5, 'MM-LIFE-002', 'Terra Recycled Tote', 'terra-recycled-tote', 'Structured everyday tote made from recycled canvas.', 'Terra Recycled Tote includes an interior bottle pocket, magnetic top closure, and reinforced handles.', 36.00, NULL, 26, 'https://placehold.co/640x480/f0e8dd/152238?text=Canvas+Tote', 4.60, 61, 1, 0, '2026-01-29 17:05:00');
