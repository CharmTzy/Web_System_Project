...
$pageTitle = 'Product Manager Demo';
$appName = $config['app']['name'];
$cartSummary = ['total_items' => 0];
$pageScript = 'product-manager.js';
$storageKey = 'product-manager-demo-public-v2';
$roleLabel = 'Demo';
...
<main>
    <section class="hero-section hero-section--compact">
        <div class="container">
            ...
            <h1 class="hero-section__title" style="max-width:20ch;">Product Management UI Demo</h1>
            <p class="hero-section__copy">Preview the admin or seller product management experience without logging in. All changes are stored only in this browser.</p>
        </div>
    </section>
